...
<template>
  <div class="intelligence-search q-pa-md">
    ...
    <!-- Filtros rápidos -->
    <div v-if="searchPerformed && totalResults > 0" class="search-filters q-mt-xs">
      <q-chip dense clickable color="primary" text-color="white" icon="filter_list">
        Filtros
      </q-chip>
      <q-chip dense clickable outline color="white">Últimos 7 dias</q-chip>
      <q-chip dense clickable outline color="white">Documentos Word</q-chip>
      <q-chip dense clickable outline color="white">Alta prioridade</q-chip>
    </div>
  </div>
</template>
