  ...
  <q-page padding class="intelligence-tags-page">
    <div class="intelligence-page-header q-mb-md">
      <div class="row items-center">
        <q-icon name="link" size="32px" color="accent" class="q-mr-md" />
        <div>
          <div class="text-h4">Vínculos</div>
          <div class="text-subtitle1 text-grey-7">Gerenciamento de Vínculos</div>
        </div>
        <q-space />
        <q-chip color="info" outline icon="info"> {{ tags.length }} Vínculos cadastrados </q-chip>
      </div>
    ...
    <div v-if="loading" class="text-center q-pa-lg">
      ...
      <div class="q-mt-sm">Carregando Vínculos...</div>
    </div>
        ...
        <q-card flat bordered class="tags-table-card">
          <q-card-section>
            <div class="intelligence-section-header q-mb-md">
              <div class="text-h6">Vínculos do Sistema</div>
